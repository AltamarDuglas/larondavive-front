 ...
 * Responsabilidad Única (SRP): Presentar el banner oficial de invitación a la ciudadanía para las jornadas de La Ronda Vive.
...
export default function StatsSection() {
  return (
    <section className="section stats-dashboard-section" aria-label="Invitación a la próxima fecha de La Ronda Vive">
      {/* Banner de invitación pública a la ciudadanía de Montería */}
      <div className="stats-highlight-banner">
        <div className="banner-content">
          <strong>¡Te esperamos en la próxima fecha de La Ronda Vive!</strong>
          <p>
